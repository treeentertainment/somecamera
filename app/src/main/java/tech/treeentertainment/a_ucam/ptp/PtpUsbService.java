...
import tech.treeentertainment.a_ucam.ptp.PtpCamera.State;

public class PtpUsbService implements PtpService {

    private final String TAG = PtpUsbService.class.getSimpleName();

    private static final String ACTION_USB_PERMISSION = "tech.treeentertainment.a_ucam.USB_PERMISSION";
