...
import tech.treeentertainment.a_ucam.view.GalleryAdapter.ViewHolder;
...
public class GalleryFragment extends SessionFragment implements Camera.StorageInfoListener,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        ft.replace(
                ...
                PictureFragment.newInstance(galleryAdapter.getItemHandle(position)),
                null  // ✅ String 타입으로 명확히 null 태그 전달
        );
